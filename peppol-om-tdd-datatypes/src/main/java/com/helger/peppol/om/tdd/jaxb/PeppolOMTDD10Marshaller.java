...
import com.helger.peppol.om.tdd.v100.ObjectFactory;
...
/**
 * This is the reader and writer for Peppol OM TDD 1.0 documents. This class may be derived to
 * override protected methods from {@link GenericJAXBMarshaller}.
 *
 * @author Philip Helger
 */
@NotThreadSafe
public class PeppolOMTDD10Marshaller extends GenericJAXBMarshaller <TaxDataType>
{
  @NonNull
  @ReturnsMutableCopy
  public static ICommonsList <ClassPathResource> getAllXSDs ()
  {
    ...
    ret.add (CPeppolOMTDD.TDD_XSD_1_0);
    return ret;
  }
  ...
  public static MapBasedNamespaceContext createNamespaceContext ()
  {
    ...
    ret.addMapping ("pxs", CPeppolOMTDD.TDD_XSD_1_0_NS);
    return ret;
  }
   ...
   * Constructor
   */
  public PeppolOMTDD10Marshaller ()
  {
