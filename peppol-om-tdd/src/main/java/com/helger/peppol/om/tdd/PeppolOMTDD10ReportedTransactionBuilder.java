...
/**
 * Builder for Peppol OM TDD 1.0 sub element called "ReportedTransaction".
 *
 * @author Philip Helger
 */
public class PeppolOMTDD10ReportedTransactionBuilder implements IBuilder <ReportedTransactionType>
{
   ...
   */
  @NonNull
  public PeppolOMTDD10ReportedTransactionBuilder initFromInvoice (@NonNull final InvoiceType aInv)
  {
   ...
   */
  @NonNull
  public PeppolOMTDD10ReportedTransactionBuilder initFromCreditNote (@NonNull final CreditNoteType aCN)
  {
  ...
  @NonNull
  public PeppolOMTDD10ReportedTransactionBuilder customizationID (@Nullable final String s)
  {
  ...
  @NonNull
  public PeppolOMTDD10ReportedTransactionBuilder profileID (@Nullable final String s)
  {
    m_sProfileID = s;
    return this;
  }
  ...
  @NonNull
  public PeppolOMTDD10ReportedTransactionBuilder id (@Nullable final String s)
  {
    m_sID = s;
    return this;
  }
  ...
  @NonNull
  public PeppolOMTDD10ReportedTransactionBuilder issueDate (@Nullable final LocalDate a)
  {
    m_aIssueDate = a;
    return this;
  }
  ...
  @NonNull
  public PeppolOMTDD10ReportedTransactionBuilder issueTime (@Nullable final XMLOffsetTime a)
  {
    return issueTime (a == null ? null : a.toOffsetTime ());
  }

  @NonNull
  public PeppolOMTDD10ReportedTransactionBuilder issueTime (@Nullable final OffsetTime a)
  {
    // XSD can only handle milliseconds
  ...
  @NonNull
  public PeppolOMTDD10ReportedTransactionBuilder issueDateTime (@Nullable final OffsetDateTime a)
  {
    if (a == null)
  ...
  @NonNull
  public PeppolOMTDD10ReportedTransactionBuilder documentTypeCode (@Nullable final String s)
  {
  ...
  @NonNull
  public PeppolOMTDD10ReportedTransactionBuilder documentCurrencyCode (@Nullable final String s)
  {
  ...
  @NonNull
  public PeppolOMTDD10ReportedTransactionBuilder taxCurrencyCode (@Nullable final String s)
  {
  ...
  @NonNull
  public PeppolOMTDD10ReportedTransactionBuilder sellerTaxID (@Nullable final String s)
  {
    m_sSellerTaxID = s;
    return this;
  }
  ...
  @NonNull
  public PeppolOMTDD10ReportedTransactionBuilder buyerID (@Nullable final String s)
  {
    m_sBuyerID = s;
    return this;
  }
  ...
  @NonNull
  public PeppolOMTDD10ReportedTransactionBuilder buyerIDSchemeID (@Nullable final String s)
  {
  ...
  @NonNull
  public PeppolOMTDD10ReportedTransactionBuilder buyerTaxID (@Nullable final String s)
  {
    m_sBuyerTaxID = s;
    return this;
  }
  ...
  @NonNull
  public PeppolOMTDD10ReportedTransactionBuilder taxTotalAmountDocumentCurrency (@Nullable final BigDecimal a)
  {
  ...
  @NonNull
  public PeppolOMTDD10ReportedTransactionBuilder taxTotalAmountTaxCurrency (@Nullable final BigDecimal a)
  {
  ...
  @NonNull
  public PeppolOMTDD10ReportedTransactionBuilder taxExclusiveTotalAmount (@Nullable final BigDecimal a)
  {
  ...
  @NonNull
  public PeppolOMTDD10ReportedTransactionBuilder addCustomContent (@Nullable final CustomContent a)
  {
    if (a != null)
  ...
  @NonNull
  public PeppolOMTDD10ReportedTransactionBuilder sourceDocument (@Nullable final Document a)
  {
    return sourceDocument (a == null ? null : a.getDocumentElement ());
  }

  @NonNull
  public PeppolOMTDD10ReportedTransactionBuilder sourceDocument (@Nullable final Element a)
  {
    m_aSourceDocument = a;
    return this;
  }
  ...
  public boolean isEveryRequiredFieldSet (final boolean bDoLogOnError)
  {
    ...
    final String sErrorPrefix = "Error in Peppol OM TDD 1.0 ReportedTransaction builder: ";
    final String sWarnPrefix = "Warning in Peppol OM TDD 1.0 ReportedTransaction builder: ";
